...
| 通識向度 | 向度一～向度六，只顯示屬於該向度的通識課，想找特定向度的人直接點選即可 |
...
課程資料由自動化程式定期從北大課程查詢系統抓取：選課與加退選旺季（1、2、8、9 月）每週三、五晚上 8 點更新，其他月份每週三晚上 8 點更新一次，更新時間會顯示在搜尋框下方的「課程資料更新時間」。如果剛好在加退選、課程異動期間，資料可能會有些延遲，請以官方選課系統的即時資訊為準。
